...
class Friends_groups extends Friends
{
	...
	function _entries ( $params = array() )
	{
		...
		if (version_compare($this->aob->ee_version, '2.6.0', '<'))
		{
	...
	function _groups( $tagdata = '', $group_type = 'owner', $return_no_results = '' )
	{
		...
		$tagdata	= ee()->functions->prep_conditionals( $tagdata, array( 'friends_total_results' => $count ) );

		$tagdata	= ee()->TMPL->swap_var_single( "friends_total_results", $count, $tagdata );
