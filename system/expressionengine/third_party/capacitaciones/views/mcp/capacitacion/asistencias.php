<div class="cmcp">
  ...
  <div class="cbody p-21">
    ...
    <br><br>
    <?=form_open($action_url, array('id' => 'form-asistencias'))?>
      <div class="cform-group cdate-group">
        <p><b>Fecha de inicio: </b> <?= $capacitacion->fecha_inicio ?> </p>
        <p><b>Fecha de fin: </b> <?= $capacitacion->fecha_fin_vigencia ?> </p>
      </div>
      <div class="cform-group cdate-group">
        <label for="cfechaasistencia">Fecha de asistencia</label>
        <input class="cdate-field" id="cfechaasistencia" type="text" name="fecha_asistencia" >
